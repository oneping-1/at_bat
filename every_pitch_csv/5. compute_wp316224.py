...
def create_wp316224() -> List[dict]:
    ...
    # dict for speed
    wp316224 = {state: {'away_win': 0, 'home_win': 0, 'tie': 0} for state in states}
...
def calculate_wp316224(re288: pd.DataFrame, wp316224: List[dict]) -> List[dict]:
    """
    ...
    """
    for state, _ in tqdm(wp316224.items()):
        ...
        wp316224[state] = {'away_win': away, 'home_win': home, 'tie': tie}

    return wp316224

def write_wp316224(wp316224: List[dict]):
    """
    ...
    with open(csv_file_path, 'w', newline='', encoding='UTF-8') as csv_file:
        ...
        for key, value in wp316224.items():
            writer.writerow({
                'balls': key[0],
                'strikes': key[1],
                'outs': key[2],
...
def main():
    ...
    """
    re288 = read_re288()
    wp316224 = create_wp316224()
    wp316224 = calculate_wp316224(re288, wp316224)
    write_wp316224(wp316224)
    for key, value in wp316224.items():
        print(key, value)
